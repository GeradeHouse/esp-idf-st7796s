 ...
 * lcds.c
 * 
 * Implementation file for managing 20x4 LCD displays.
 * 
 * This file provides functions to initialize, update, and de-initialize
 * two 20x4 LCD displays using the ESP-IDF framework.
 * It utilizes the custom I2C master driver for communication with the LCDs.
 * 
