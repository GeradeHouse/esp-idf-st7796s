 ...
 * st7796s.c
 * 
 * Driver for 3.5 Inch 320x480 SPI TFT display with the ST7796S driver.
 * 
 * This file provides functions to initialize, update, and de-initialize
 * displays using the ESP-IDF framework.
 * It communicates with the LCDs via SPI interface.
 * 
