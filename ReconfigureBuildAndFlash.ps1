# ---------------------------------------------------------------------------
# Script Name: ReconfigureBuildAndFlash.ps1
# Description: This script reconfigures, builds, flashes, and monitors the ESP-IDF project with retry options.
# Author: GeradeHouse
# Date: 15-11-2024
# ---------------------------------------------------------------------------
...
# Step 1: Reconfigure
Execute-Command -Command "idf.py" -Arguments @("reconfigure") -ErrorMessage "Error: 'idf.py reconfigure' failed."
